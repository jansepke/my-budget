...
import { TransactionBackend, TransactionDTO, TransactionWithRowDTO } from "@/domain";
...
export const getAllTransactions = async (session: Session): Promise<TransactionWithRowDTO[]> => {
  try {
